...
val deck1 = Deck().fillDeck(ListBuffer[Card]())
val deck2 = Deck().fillDeck(ListBuffer[Card]())
deck2.shuffle(deck1.cards)
print(deck1)
print(deck2)
deck1.shuffle(ListBuffer[Card]())
print(deck1)
deck1.copy(deck = ListBuffer[Card](
