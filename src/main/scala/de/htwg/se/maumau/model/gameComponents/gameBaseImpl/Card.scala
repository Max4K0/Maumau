...
case class Card(color: Color, symbol: Symbols) {
  ...
  val SA: String = black2 + "\uD83C\uDCA1"
  val S2: String = black2 + "\uD83C\uDCA2"
  val S3: String = black2 + "\uD83C\uDCA3"
  val S4: String = black2 + "\uD83C\uDCA4"
  val S5: String = black2 + "\uD83C\uDCA5"
  val S6: String = black2 + "\uD83C\uDCA6"
  val S7: String = black2 + "\uD83C\uDCA7"
  val S8: String = black2 + "\uD83C\uDCA8"
  val S9: String = black2 + "\uD83C\uDCA9"
  val S10: String = black2 + "\uD83C\uDCAA"
  val SJ: String = black2 + "\uD83C\uDCAB"
  val SL: String = black2 + "\uD83C\uDCAD"
  val SK: String = black2 + "\uD83C\uDCAE"
